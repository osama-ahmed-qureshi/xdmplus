...
import xdmplus.network.ProxyResolver;
import xdmplus.network.http.HeaderCollection;
import xdmplus.network.http.HttpHeader;
import xdmplus.network.http.JavaClientRequiredException;
import xdmplus.network.http.JavaHttpClient;
import xdmplus.network.http.WebProxy;
import xdmplus.network.http.XDMHttpClient;
