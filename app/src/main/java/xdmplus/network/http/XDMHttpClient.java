package xdmplus.network.http;

import java.io.*;
import java.net.*;

import xdmplus.network.FixedRangeInputStream;
import xdmplus.network.HostUnreachableException;
import xdmplus.network.KeepAliveConnectionCache;
import xdmplus.network.NetworkException;
import xdmplus.network.ParsedURL;
import xdmplus.network.SocketFactory;
import xdmplus.util.*;
